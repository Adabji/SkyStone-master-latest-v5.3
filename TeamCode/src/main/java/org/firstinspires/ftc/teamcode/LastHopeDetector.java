...
public class LastHopeDetector extends DogeCVDetector {
    ...
    public Mat process(Mat input) {
        ...
        // Imgproc.line(input, new Point(0, 80), new Point(240, 80), new Scalar(150, 150, 150), 160, Imgproc.LINE_4, 0);
